...
<title>Nouveau fournisseur</title>
	...
	<body>
		...
		<div class="corps">
			<form action="FournisseurAjoutControleur" method="post">
				Nom <input type="text" name="nom_fournisseur" class="nom"/> <br />
		
				<input type="submit" value="Ajouter le fournisseur" class="valider"/>
			</form>
		</div>
